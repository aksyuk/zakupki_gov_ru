...
#  * создаёт два csv-файла: один с данными, имя -- второй аргумент функции;
#    второй с метаданными -- столбцы имя столбца, тип данных, имя -- второй
#    аргумент функции + _META перед расширением файла
#
